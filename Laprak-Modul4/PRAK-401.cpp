...
{
    menu:
    cout<<"Double Linkied List Non Circular (DLLNC)"<<endl;
    cout<<"========================================"<<endl;
    cout<<"Silahkan pilih progam DLLNC yang ingin dijalankan!"<<endl;
    ...
    if(menu==1){
        ...
        cout<<"\nTERIMA KASIH"<<endl;
        cout<<"Program was made by Amandha Citra Mustika (2410817320004)."<<endl;
    }
}
...
void tambahDepanH() {
    ...
    cout << "Data \""<<dataBaru<<"\" berhasil ditambahkan di bagian depan.";
}
